...
public abstract class Game {
  ...
  public static Game create(int gameId, int sportId, int creator, String placeId, String date, Collection<Team> teams, List<Integer> woohoos, List<Comment> comments) {
